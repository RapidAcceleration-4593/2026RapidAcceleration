...
public final class AngleMechanism3D extends SimpleMechanism3D {
    ...
    /**
     * Creates a new {@link AngleMechanism3D} which will set the rotation of the given {@link Node3D} along the given
     * axis.
     *
     ...
     * @param node The {@link Node3D} whose pose should be updated by this {@link AngleMechanism3D}.
     * @param axis The axis, in object space along which the {@link Node3D} should be rotated.
     * @param inverted If true, the input to {@link #setAngle()} will be multiplied by -1 before being applied to the
     *     {@link Node3D}.
     */
