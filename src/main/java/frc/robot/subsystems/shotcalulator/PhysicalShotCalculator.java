...
public class PhysicalShotCalculator extends SubsystemBase {
    ...
    private ShotCalculation calculateBestShot(Pose2d position) {
        double distanceX =
                kTarget.toTranslation2d().minus(position.getTranslation()).getNorm();
        return null;
    }
    ...
    public record ShotCalculation(Angle hoodAngle, AngularVelocity shooterVelocity, boolean inRange) {}
}
