...
public abstract class ModuleIOTalonFX implements ModuleIO {
    ...
    protected final TorqueCurrentFOC torqueCurrentRequest = new TorqueCurrentFOC(0.0);
    ...
    protected ModuleIOTalonFX(
        ...
        if (kCurrentMode == Mode.SIM) turnConfig.Slot0.withKD(0.5).withKS(0.0);
        ...
        turnConfig.Feedback.FeedbackSensorSource = switch (constants.FeedbackSource) {
            ...
            default -> throw new RuntimeException("You are using an unsupported swerve configuration.");
        };
