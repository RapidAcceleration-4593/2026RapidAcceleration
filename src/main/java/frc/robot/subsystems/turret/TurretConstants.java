...
public final class TurretConstants {
    ...
    public static final Angle kMinimumAngle = Degrees.of(-90.0);
    public static final Angle kMaximumAngle = Degrees.of(270.0);
    public static final Angle kAngleTolerance = Degrees.of(25.0);
    public static final Angle kWrapMargin = Degrees.of(15.0);

    public static final int kCountsPerRotation = 8192;
    public static final double kMotorToEncoderGearing = (5.0 * 5.0);
